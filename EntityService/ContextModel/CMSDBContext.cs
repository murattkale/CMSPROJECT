...
public partial class CMSDBContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        {
            optionsBuilder.UseNpgsql("Host=78.188.40.28;Database=DyDB;Username=postgres;Password=123_*1", x => x.MigrationsHistoryTable("__EFMigrationsHistory", "mySchema"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        //{
        //    entity.Property(e => e.ContentPageId).IsRequired();
