...
namespace DynamicSite.Controllers
{
    public class BaseController : Controller
    {
        ...
        public IActionResult Sayfa()
        {
            ...
            {
                var menu = _IContentPageService.Where(o => o.Link == link, true, false,o=>o.ContentPageChilds, o => o.Parent, o => o.Documents, o => o.Picture, o => o.ThumbImage, o => o.BannerImage,o=>o.Gallery).Result.FirstOrDefault();
                if (menu != null)
                {
                    ViewBag.page = menu;
                    return View();
        ...
        public void setData()
        {
            ...
            var contentPages = _IContentPageService.Where(null, true, false,
                o => o.ContentPageChilds, o => o.Parent, o => o.Documents, o => o.Picture, o => o.ThumbImage, o => o.BannerImage, o => o.Gallery).Result.ToList();
