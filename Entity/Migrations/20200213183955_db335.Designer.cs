...
namespace Entity.Migrations
{
    ...
    [Migration("20200213183955_db335")]
    partial class db335
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entity.CMSDB.ContentPage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Entity.CMSDB.Documents", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Entity.CMSDB.Formlar", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Entity.CMSDB.Documents", b =>
                {
                    b.HasOne("Entity.CMSDB.ContentPage", "ContentPage")
                        .WithMany("Documents")
            ...
            modelBuilder.Entity("Entity.CMSDB.Roles", b =>
                {
                    b.HasOne("Entity.CMSDB.Roles", "Parent")
                        .WithMany("InverseParent")
                        .HasForeignKey("ParentId")
                        .HasConstraintName("FK_Roles_Roles");

                    b.HasOne("Entity.CMSDB.ServiceConfig", "StartPage")
                        .WithMany("Roles")
